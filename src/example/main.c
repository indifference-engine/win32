...
static void tick(const void *const context, const int pointer_state, const float pointer_row, const float pointer_column, bool (*const key_held)(const void *const context, const WPARAM virtual_key_code))
{
  previous_x = next_x;
...
static void video_pointer(const int state, const float row, const float column, const float none_red, const float none_green, const float none_blue, const float hover_red, const float hover_green, const float hover_blue, const float select_red, const float select_green, const float select_blue)
{
...
static void video(const void *const context, const int pointer_state, const float pointer_row, const float pointer_column, bool (*const key_held)(const void *const context, const WPARAM virtual_key_code), const float tick_progress_unit_interval)
{
  ...
  video_pointer(tick_pointer_state, tick_pointer_row, tick_pointer_column, 1, 0, 0, 0, 1, 0, 0, 0, 1);
  video_pointer(pointer_state, pointer_row, pointer_column, 0, 1, 1, 1, 0, 1, 1, 1, 0);
